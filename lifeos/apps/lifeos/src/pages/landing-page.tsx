/**
 * Trackly Landing Page — Premium Persian RTL SaaS
    ...
    >
      <div className={styles.navInner}>
        <div className={styles.navLogo}>
          ...
          />
          <span className={styles.navLogoText}>Trackly</span>
        </div>
        ...
        <div className={styles.navActions}>
          <button className={styles.navBtnGhost} onClick={onLogin}>
            ورود
          </button>
          <button className={styles.navBtnPrimary} onClick={onLogin}>
            شروع رایگان
          </button>
        </div>
      </div>
  ...
  return (
    <div className={styles.mockup}>
      <div className={styles.mockupBar}>
        ...
        <span className={styles.mockupTitle}>Trackly Dashboard</span>
      </div>
      <div className={styles.mockupBody}>
        {/* hero card */}
        <div className={styles.mockupHero}>
          <div className={styles.mockupHeroLabel}>هزینه این ماه</div>
          <div className={styles.mockupHeroAmount}>
            ۷,۶۰۲,۰۰۰ <span>تومان</span>
          </div>
          ...
          {/* mini sparkline */}
          <svg
            className={styles.mockupSparkline}
            viewBox="0 0 120 36"
            fill="none"
          >
            <polyline
              points="0,28 20,22 40,26 60,14 80,18 100,8 120,10"
              stroke="#3B82F6"
              strokeWidth="2"
              strokeLinecap="round"
            ...
            />
            <polyline
              points="0,28 20,22 40,26 60,14 80,18 100,8 120,10 120,36 0,36"
              fill="url(#sg)"
              opacity="0.15"
            />
            <defs>
        ...
        <div className={styles.mockupList}>
          {services.map((s) => (
            <div key={s.name} className={styles.mockupService}>
              <div
                className={styles.mockupServiceIcon}
              ...
              <div className={styles.mockupServiceInfo}>
                ...
                <span className={styles.mockupServiceDays}>
                  {s.days} روز دیگر
                </span>
              </div>
      ...
      <div className={styles.heroInner}>
        ...
        >
          ...
          <motion.h1 variants={fadeUp} className={styles.heroH1}>
            ...
            <span className={styles.heroAccent}>هوشمند</span> مدیریت کن
          </motion.h1>

          <motion.p variants={fadeUp} className={styles.heroSub}>
            اشتراک‌ها، پرداخت‌های ماهانه و تمدیدها را در یک داشبورد ساده و
            حرفه‌ای کنترل کن. هیچ سرویسی فراموش نمی‌شود.
          </motion.p>
          ...
          <motion.div variants={fadeUp} className={styles.heroTrust}>
            {["بدون نیاز به کارت اعتباری", "نصب فوری", "رایگان برای همیشه"].map(
              (t) => (
      ...
      <div className={styles.sectionInner}>
        ...
        <motion.div variants={stagger(0.06)} className={styles.problemGrid}>
          {problemServices.map((s, i) => (
            ...
            >
              <div
                className={styles.problemCardIcon}
        ...
        <motion.div variants={fadeUp} className={styles.problemResult}>
          ...
          >
            <div className={styles.problemResultTotal}>
              ...
              <span className={styles.problemResultLabel}>
                تومان در ماه — بدون اینکه بدانی!
              </span>
            </div>
          </PixelCard>
        </motion.div>
        ...
        titleComponent={
          <div className={styles.scrollShowcaseTitle}>
            ...
            <p className={styles.sectionSub} style={{ margin: "0 auto" }}>
              داشبورد Trackly تمام اشتراک‌ها، هزینه‌ها و تمدیدهای تو را در یک
              صفحه نشان می‌دهد.
            </p>
          </div>
        }
      ...
      <div className={styles.subGrid2}>
        ...
        <motion.div variants={stagger(0.1)} className={styles.subHeaderCell}>
          ...
          <motion.p variants={fadeUp} className={styles.subIntro}>
            مدیریت اشتراک‌های دیجیتال هیچ‌وقت اینقدر ساده نبوده. تمام سرویس‌هایی
            که هر ماه پرداخت می‌کنی را در یک داشبورد واضح ببین، تمدیدها را زیر
            نظر بگیر و هزینه‌هایت را کنترل کن.
          </motion.p>
        </motion.div>
        ...
        <motion.div variants={fadeUp} className={styles.subImageCell}>
          <img
            src="/hero1.jpg"
            alt="Trackly subscription management"
        ...
        <motion.div variants={stagger(0.1)} className={styles.subBodyCell}>
          <motion.p variants={fadeUp} className={styles.subBodyText}>
            با Trackly دیگر لازم نیست نگران فراموش کردن تاریخ تمدید یا پرداخت
            ناخواسته باشی. سیستم هوشمند یادآوری، قبل از هر تمدید به تو اطلاع
            می‌دهد تا بتوانی تصمیم بگیری. تمام اشتراک‌ها با قیمت، دسته‌بندی و
            وضعیت نمایش داده می‌شوند.
          </motion.p>
          ...
          <motion.ul variants={stagger(0.1)} className={styles.subFeatureList}>
            {[
              ...
              >
                ...
                <span>
                  <strong className={styles.subFeatureTitle}>
                    {f.title}.{" "}
                  </strong>
          ...
          <motion.p
            variants={fadeUp}
            className={styles.subBodyText}
            style={{ marginTop: 24 }}
          >
            همه داده‌ها به صورت امن در مرورگر شما ذخیره می‌شوند. هیچ اطلاعاتی به
            سرور خارجی ارسال نمی‌شود و حریم خصوصی شما کاملاً محفوظ است.
          </motion.p>
          ...
          <motion.div variants={fadeUp} className={styles.subExtra}>
            ...
            <p className={styles.subExtraDesc}>
              Trackly کاملاً در مرورگر کار می‌کند. نه نیاز به حساب کاربری خاصی،
              نه نگرانی از نشت داده. همه چیز روی دستگاه شما — زیر کنترل شما.
            </p>
          </motion.div>
        </motion.div>
      </div>
      ...
      <div className={styles.sectionInner}>
        ...
        <motion.div variants={stagger(0.09)} className={styles.analyticsCard}>
          ...
          <motion.div
            ...
            className={styles.analyticsRight}
          >
    ...
    <Section className={styles.cta}>
      ...
      <div className={styles.sectionInner}>
        ...
        <motion.p variants={fadeIn} className={styles.ctaNote}>
          بیش از ۱۰۰۰ نفر از Trackly استفاده می‌کنند
        </motion.p>
      </div>
    </Section>
  );
      ...
      <div className={styles.footerContent}>
        ...
        <div className={styles.footerRight}>
          ...
          <p className={styles.footerTagline}>
            یک سامانه هوشمند برای مدیریت اشتراک‌ها،
            <br />
          ...
          <p className={styles.footerCopy}>
            Trackly © 1405 — همه حقوق محفوظ است
          </p>
        </div>
        <div className={styles.landingCredit}>
          <span>© 2026 Trackly</span>
          <span className={styles.landingCreditDot}>·</span>
          <span>Designed &amp; Developed by</span>
          <span className={styles.landingCreditName}>Hamed Farazi</span>
        </div>
        ...
        <div className={styles.footerLeft}>
          ...
          <p className={styles.newsletterSub}>
            آخرین اخبار، مقالات و به‌روزرسانی‌های Trackly را هر هفته دریافت کن.
          </p>
